...
export default function CreateFoodForm({ onSubmit, onCancel, refreshFoods, merchantID }) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
        ...
        >
          <h3 className="text-xl font-bold mb-4 text-[var(--foreground)]">Add food to Menu</h3>
          ...
          >
            ...
            >
              <h3 className="text-lg font-semibold text-[var(--foreground)] mb-4">
                Are you sure you want to add this food in your menu?
              </h3>
